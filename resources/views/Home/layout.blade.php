...
<body class="ecommerce">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        <li><i class="fa fa-phone"></i><span>+86 136 9101 1114</span></li>
                        <!-- BEGIN CURRENCIES -->
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="#" style="position: absolute; left: 0px; top: -10px;">
        <img style="width:225px" src="{{ asset('/assets/img/logo.jpg') }}" alt="Metronic Shop UI"></a>
