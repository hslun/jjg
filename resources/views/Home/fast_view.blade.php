        ...
        <div class="product-page product-pop-up">
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-9">
              <h2 class="fast_name">Cool green dress with red bell</h2>
              <div class="price-availability-block clearfix">
                <div class="price">
                  <strong><span>$</span><c class="fast_price">472.00</c></strong>
...
<script>
function fast_view(img_url, name, price, description){
 $('.product-main-image .img-responsive').attr('src', img_url) 
 $('.fast_name').html(name)
 $('.fast_price').html(price)
